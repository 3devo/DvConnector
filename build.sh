...
function build_linux()
{
    ...
    cp -r default-files/* ./release/feconnector-$1_linux_$2 1>/dev/null 2>> $startDir/error.log || error $LINENO
...
function build_windows()
{
    ...
    cp -r default-files/* ./release/feconnector-$1_windows_$2 1>/dev/null 2>> $startDir/error.log || error $LINENO
...
function build_osx()
{
    ...
    cp -r default-files/* ./release/feconnector-$1_darwin_amd64 1>/dev/null 2>> $startDir/error.log || error $LINENO
