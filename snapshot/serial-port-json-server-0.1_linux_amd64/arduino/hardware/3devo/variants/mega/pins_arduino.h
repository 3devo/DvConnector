/*
  pins_arduino.h - Pin definition functions for 3Devo boards
  Based on the pin definitions for the Arduino Mega

  Copyright (c) 2007 David A. Mellis
  Copyright (c) 2016 3Devo http://www.3devo.eu
...
// Extra digital pins not present on the regular Arduino Mega
#define DPH2 70
#define DPH7 71
#define DPJ2 72
#define DPJ3 73
